...
// https://github.com/jellyfin/Swiftfin/blob/main/Shared/Objects/DeviceProfileBuilder.swift
public class DeviceProfileBuilder {
    ...
    var bitrate: Int = 40000000

    func setMaxBitrate(_ bitrate: Int) {
        self.bitrate = bitrate
    }
    
    func build() -> DeviceProfile {
        ...
        profile.maxStaticBitrate = maxStaticBitrate
        profile.musicStreamingTranscodingBitrate = musicStreamingTranscodingBitrate
